...
class LineChartSample6 extends StatelessWidget {
  LineChartSample6({
    ...
    Color? line2Color1,
    Color? line2Color2,
  })  : line1Color1 = line1Color1 ?? Colors.red,
        line1Color2 = line1Color2 ?? Colors.red,
  ...
  Widget topTitleWidgets(double value, TitleMeta meta) {
    ...
    return SideTitleWidget(
      ...
      child: Text(value.toInt().toString(), style: TextStyle(fontSize: 18,color: Colors.black))
    );
  }
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: const Text('Line Chart Sample 6')
      ),
      body: Padding(
